...
<head>
  ...
  <title><?php echo $title_web;?> | Perpustakaan SMA PGRI TANJUNGPANDAN</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS SMAPI</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
            ...
            <!-- tombol profil aktif untuk edit -->
            <!-- <a href="<= base_url('user/edit/'.$idbo);?>">
             <i class="fa fa-user"> </i> <php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a> -->
            <!-- sampai sini -->
            <!-- tombol profil nonaktif untuk edit -->
             <a>
             <i class="fa fa-user"> </i> <?php echo $d->nama; echo ' | ( '.$d->level.' )'; ?></a>
             <!-- sampai sini -->
          </li>
          <li>
            <a href="<?php echo base_url();?>login/logout"><b>Log out</b></a>
          </li>
