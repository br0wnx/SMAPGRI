					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								...
								<input type="text" name="kategori"  value="<?=$kat->nama_kategori;?>" id="kategori" class="form-control"  placeholder="Contoh : Biografi, Novel, dll" >
							...
							<form method="post" action="<?= base_url('data/katproses');?>">
								<div class="form-group">
								<label for="">Nama Kategori</label>
								<input type="text" name="kategori" id="kategori" class="form-control" placeholder="Contoh : Biografi, Novel, dll" >
...
<!-- untuk keterangan -->
					<div class="box box box-primary">
						...
						<div>
						<div class="box-body">
                              <div> 000 - 090 = umum</div>
							  <div> 100 - 190 = Filsafat dan Psikologi</div>
							  <div> 200 = Agama</div>
							  <div> 300 - 390 = Sosial</div>
							  <div> 400 = Bahasa</div>
							  <div> 500 - 590 = Sains dan Matematika</div>
							  <div> 600 - 690 = Teknologi</div>
							  <div> 700 - 790 = Seni dan Rekreasi</div>
							  <div> 800 = Literartur dan Sastra</div>
							  <div> 900 - 990 = Sejarah dan Geografi</div>
