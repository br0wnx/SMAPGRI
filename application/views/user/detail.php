            ...
            <page size="A4">
				<div class="panel panel-default">
					<div class="panel-body">
						<h4 class="text-center"><b>KARTU ANGGOTA PERPUSTAKAAN</b></h4>
						<h4 class="text-center"><b>SMA PGRI TanjungPandan</b></h4>
						<br/>
						<div class="row">
							<div class="col-sm-12">
								...
								<center>
									<img src="<?php echo base_url();?>assets_style/image/<?php echo $user->foto;?>" style="width:3cm;" class="img-responsive">
								</center>
							</div>
							</div>
