                    ...
                    <form action="<?php echo base_url('user/upd');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group">
                                    <label>NIS/NIP</label>
                                    <input type="text" class="form-control" value="<?= $user->nisnip;?>" name="nisnip" required="required" placeholder="nisnip">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" value="<?= $user->telepon;?>" name="telepon" required="required" placeholder="Contoh : 081234567353">
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input type="email"  value="<?= $user->email;?>" readonly class="form-control" name="email" required="required" placeholder="Contoh : gegenaldy22@gmail.com">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <img src="<?= base_url('assets_style/image/'.$user->foto);?>" class="img-responsive" style="height:auto;width:100px;" alt="#">
                                </div>
